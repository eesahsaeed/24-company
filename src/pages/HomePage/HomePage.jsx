...
import OurWorkCard from "./component/OurWorkCard/OurWorkCard";
import { workData } from "../WorkDetails/work";

const OurWorkData = workData;
  ...
  return (
    ...
    >
      <main className="relative pt-20 pb-5  lg:pl-16 main-wrapper md:pl-12 pl-6 lg:grid lg:grid-cols-2 gap-5">
        ...
        <div className="text-2xl pr-6 cursor-pointer  md:col-span-2 gap-5 md:grid md:grid-cols-3 ">
          <h2
            ...
            className="flex items-center mb-2 md:mb-0 text-yellow-500 pb-5 md:border-b-2 border-yellow-500 border-opacity-50 hover:border-opacity-100"
          >
            <BsFillTriangleFill className="mr-4" />
            Startups
          </h2>
          <h2
            onMouseEnter={() =>
              setData({
                one: "Technology consulting",
                two: "Embedded teams",
                three: "Software modernization",
              })
            }
            className="flex items-center mb-2 md:mb-0 text-blue-500 pb-5 md:border-b-2 border-blue-500 border-opacity-50 hover:border-opacity-100"
          >
            <BsFillSquareFill className="mr-4" />
            Enterprise
          </h2>
          <h2
            onMouseEnter={() =>
              setData({
                ...
                two: "Technology consulting",
                three: "Advenced business solutions",
              })
            }
            className="flex items-center mb-2 md:mb-0 text-green-500 pb-5 md:border-b-2 border-green-500 border-opacity-50 hover:border-opacity-100"
          >
            <BsFillCircleFill className="mr-4" />
            SMB
          </h2>
          <h2 className="text-white invisible md:visible h-0 md:h-auto">
            {data.one}
          </h2>
          <h2 className="text-white invisible md:visible h-0 md:h-auto">
            {data.two}
      ...
      <MainSection className="">
        ...
        <div className="w-full">
          <h6 className="text2  sm:text-4xl text-xl font-bold font-sans mb-5 ">
            Our Work
          </h6>
          <p className=" sm:text-lg text-base single-core-text font-normal paragraph">
          ...
          <div className="our_work_cards__wrapper">
        ...
        <div className="w-full py-20">
          ...
          >
            ...
            <SingleServices
              ...
              text="We develop powerful applications that provide a thrilling experience for your users and bring tangible value to your business. Whether native, hybrid or cross platform, our mobile development team delivers solutions that run seamlessly on all major operating systems and all major mobile devices."
            />
          </div>
      ...
      <MainSection bg="#F7F8F9">
        <div className="py-10">
          ...
          <h4 className="my-5 text-xl">
            ...
            deliver a mobile or web application the way you want it.
          </h4>
